  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-32 items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Link 
          href="/overview"
          className="group bg-[#412A22]/90 border border-white/20 text-white text-lg md:text-xl font-semibold px-12 py-4 rounded-xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-4"
        >
          ENTRAR
