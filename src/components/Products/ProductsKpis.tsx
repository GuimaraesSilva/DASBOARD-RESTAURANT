    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <CardContent>
          <div className="flex items-start justify-between">
            <div className="flex flex-col">
              <p className="font-medium text-gray-600 mb-4">Total Products</p>
              <h3 className="text-3xl font-bold text-gray-900">{metrics.totalProducts}</h3>
      ...
      <Card>
        <CardContent>
          <div className="flex items-start justify-between">
            <div className="flex flex-col">
              <p className="font-medium text-gray-600 mb-4">Stock Value</p>
      ...
      <Card>
        <CardContent>
          <div className="flex items-start justify-between">
            <div className="flex flex-col">
              <p className="font-medium text-gray-600 mb-4">Avg Profit Margin</p>
              <h3 className="text-3xl font-bold text-gray-900">
      ...
      <Card>
        <CardContent>
          <div className="flex items-start justify-between">
            <div className="flex flex-col">
              <p className="font-medium text-gray-600 mb-4">Low Stock Alert</p>
